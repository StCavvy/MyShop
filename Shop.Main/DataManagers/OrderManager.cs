...
namespace Shop.Main.DataManagers
{
    ...
    {
        public static async void AddOrder(int ID, int UserId, DateTime OrderDate, int ProductsCount, List<int> ProductsId, int PackerId, OrderStates OrderState, string str)
        {
            await Task.Run(() =>
            {
